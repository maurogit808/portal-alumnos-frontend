...
const FormularioAlumno = ({ 
  ...
  return (
    // Agregamos un contenedor con width 100% para evitar desbordes
    <div style={{ width: '100%', boxSizing: 'border-box' }}>
      <form onSubmit={onSubmit} style={styles.formGrid}>
        ...
        {/* Botón forzado a 100% de ancho para evitar desbordes */}
        <div style={{ width: '100%', marginTop: '10px' }}>
          <button type="submit" disabled={formLoading} style={{...styles.saveBtn, width: '100%'}}>
            {formLoading 
              ? 'Guardando...' 
